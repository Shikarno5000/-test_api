...
return new class extends Migration
{
    ...
    {
        Schema::create('chapter_software', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            ...
            $table->foreignId('software_id')->unsigned()->constrained()->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('chapter_software');
    }
};
