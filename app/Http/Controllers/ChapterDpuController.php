...
use App\Models\ChapterDpu;

class ChapterDpuController extends Controller
{
  protected $model;

  public function __construct(ChapterDpu $model)
  {
    $this->middleware('auth:api');
    $this->middleware('requestValidation:App\Models\ChapterDpu', ['only' => ['update', 'store']]);
    $this->model = $model;
  }
