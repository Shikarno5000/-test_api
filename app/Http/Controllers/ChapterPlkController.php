...
use App\Models\ChapterPlk;

class ChapterPlkController extends Controller
{
  protected $model;

  public function __construct(ChapterPlk $model)
  {
    $this->middleware('auth:api');
    $this->middleware('requestValidation:App\Models\ChapterPlk', ['only' => ['update', 'store']]);
    $this->model = $model;
  }
